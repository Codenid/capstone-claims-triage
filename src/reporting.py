...
ETAPAS: list[Etapa] = [
    ...
    Etapa("E13", "EDA", "¿Vale un embedding? TF-IDF vs embedding local",
          "e13_embeddings.csv", "python -m src.features.embeddings"),
    Etapa("E14", "EDA", "Estructura latente: UMAP + HDBSCAN",
          "e14_clusters.csv", "python -m src.data.cluster_evidence"),
    Etapa("F2", "Pipeline", "Tipado y contrato de esquema (pandera)",
          "f2_contrato.csv", "python -m src.data.typing"),
    Etapa("F3", "Pipeline", "Canonicalización de taxonomía",
          "f3_taxonomia.csv", "python -m src.data.canonicalize"),
